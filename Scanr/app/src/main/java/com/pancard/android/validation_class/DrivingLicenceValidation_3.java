 ...
 */
public class DrivingLicenceValidation_3 {
    // Licence variable
    public boolean bo_licence_date = false;
    public boolean licence_issues_date = false;
    public boolean bo_licence_number = false;
    boolean licence_till_date = false;
    String pancardname;
    Context context;

    public DrivingLicenceValidation_3(Context context) {
    ...
    private Bitmap cutLicenceNameImage(Bitmap origialBitmap) {
        ...
        Rect desRect = new Rect(origialBitmap.getWidth() / 3 - 20, origialBitmap.getHeight() / 3 - 20, origialBitmap.getWidth() - 150, origialBitmap.getHeight() / 3 + 60);
...
//            imageText += textBlock.getValue();
            pancardname += " " + textBlock.getValue();
...
//                duplicateName_value(oldBitmap);
    ...
    public void cutUpperHalfImage(Bitmap origialBitmap) {
        Bitmap cutBitmap = Bitmap.createBitmap(origialBitmap.getWidth() - 150,
                origialBitmap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(cutBitmap);
        Rect desRect = new Rect(70, 30, origialBitmap.getWidth() - 150, origialBitmap.getHeight() / 3);
        canvas.drawBitmap(origialBitmap, desRect, desRect, null);
    ...
    public void cutLowerHalfImage(Bitmap origialBitmap) {
        Bitmap cutBitmap = Bitmap.createBitmap(origialBitmap.getWidth() - 150,
                origialBitmap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(cutBitmap);
        Rect desRect = new Rect(70, origialBitmap.getHeight() / 2 - 10, origialBitmap.getWidth() / 2 + 20, origialBitmap.getHeight() / 2 + 90);
    ...
    public void cutAddressPortionImage(Bitmap origialBitmap) {
        Bitmap cutBitmap = Bitmap.createBitmap(origialBitmap.getWidth() - 150,
                origialBitmap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(cutBitmap);
        Rect desRect = new Rect(75, origialBitmap.getHeight() / 3 + 60, origialBitmap.getWidth() - 150, origialBitmap.getHeight() / 3 + 100);
