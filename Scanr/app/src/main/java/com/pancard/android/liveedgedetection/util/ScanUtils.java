package com.pancard.android.liveedgedetection.util;
...
import com.pancard.android.liveedgedetection.view.Quadrilateral;
...
public class ScanUtils {
    ...
    public static int configureCameraAngle(Activity activity) {
        Log.e("configuring ", "camera angle");
        int angle;
    ...
    public static List<PointF> detectLargestQuadrilateral(Mat mat) {
...
//        Imgproc.threshold(mGrayMat, mGrayMat, 150, 255, THRESH_BINARY + THRESH_OTSU);
        ...
        Imgproc.cvtColor(mat, mGrayMat, Imgproc.COLOR_BGR2GRAY);
        Imgproc.GaussianBlur(mGrayMat, mGrayMat, new Size(5, 5), 0);
        Imgproc.Canny(mGrayMat, mGrayMat, 75, 200);


        MatOfPoint2f largestContour = findLargestContour(mGrayMat);
...
//    }
    ...
    public static boolean isScanPointsValid(List<PointF> points) {
